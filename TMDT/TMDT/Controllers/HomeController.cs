    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult QuenMatKhau(string userEmail)
        {
            try
            {
                ...
                MailMessage mail = new MailMessage();
                mail.From = new MailAddress("kienpro0987@gmail.com"); // Email của bạn
                ...
                smtpClient.Credentials = new NetworkCredential("kienpro0987@gmail.com", "nfcq qelz hnyl elcz"); // Thông tin đăng nhập Gmail
