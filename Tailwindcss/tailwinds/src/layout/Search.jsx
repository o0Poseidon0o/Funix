...
import Job from "../compoments/Job"

export default function Search() {
  return (
    <div className="w-[40rem] rounded-md bg-white p-1">
      <div className="flex items-center">
        ...
        <button className="round-md bg-blue-500 px-4 py-2 text-white hover:bg-blue-200">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
